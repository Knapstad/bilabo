                ...
                cartemplate.update(
                    {
                        ...
                        "img": cloudinary.uploader.upload(car["attributes"].get("imageUrl", ""), folder="fleks", overwrite=False, public_id=f'{car["attributes"].get("modelDescription","")}{car["attributes"].get("imageUrl", "").split("/")[-1].split(".")[0]}')["secure_url"]
